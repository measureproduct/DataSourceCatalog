...
public class Test {
    ...
    public void testMeasure() {
        ...
        measure.getProperties().put("queryField", "return ArchimateView.latest.all.select(v|v.Represented.size > 0).collect(v|v.Represented.select(r|r.isKindOf(Concept)).size).sum();");
