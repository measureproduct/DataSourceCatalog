...
public class Test {
    ...
    public void testMeasure() {
        ...
        measure.getProperties().put("queryField", "return Element.latest.all.select(e|not e.revRefNav_Represented.isEmpty and e.hawkParent.isKindOf(BusinessFolder)).size;");
