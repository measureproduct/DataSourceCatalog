...
public class Test {
    ...
    public void testMeasure() {
        ...
        measure.getProperties().put("queryField", "var allElts=Element.latest.all; return allElts.select(e|e.revRefNav_Represented.isEmpty).size.asDouble()/allElts.size.asDouble();");
